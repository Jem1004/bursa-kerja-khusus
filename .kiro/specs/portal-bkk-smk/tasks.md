...
- [-] 2. Setup database schema dan Prisma
  ...
  - [-] 2.2 Create initial migration dan seed script
...
- [ ] 3. Implement authentication system
  - [ ] 3.1 Setup NextAuth.js dengan Credentials Provider
  ...
  - [ ] 3.2 Create login API endpoint dan page
  ...
  - [ ] 3.4 Implement middleware untuk route protection
    - Create middleware.ts untuk check authentication pada /admin/\* routes
    - Redirect unauthenticated users ke /admin/login
    - _Requirements: 7.1, 7.2, 7.3, 7.4, 7.5_

- [ ] 4. Build admin dashboard layout dan navigation
  - [ ] 4.1 Create admin layout component
...
- [ ] 5. Implement Loker CRUD functionality
  - [ ] 5.1 Create Loker API endpoints
  ...
  - [ ] 5.2 Create Loker list page di admin dashboard
    ...
    - _Requirements: 2.1_
  - [ ] 5.3 Create Loker form untuk create dan edit
...
- [ ] 6. Implement Halaman static pages CRUD
  - [ ] 6.1 Create Halaman API endpoints
  ...
  - [ ] 6.2 Create Halaman list dan edit pages di admin dashboard
...
- [ ] 7. Build public frontend - Landing page
  ...
  - [ ] 7.2 Create landing page dengan loker list
  ...
  - [ ] 7.3 Implement Header navigation
...
- [ ] 8. Build public frontend - Detail pages
  - [ ] 8.1 Create Loker detail page
  ...
  - [ ] 8.2 Create dynamic static pages
...
- [ ] 9. Implement root layout dan global styles
  - [ ] 9.1 Configure root layout
...
- [ ] 10. Add data validation dan error handling
  - [ ] 10.1 Create Zod validation schemas
